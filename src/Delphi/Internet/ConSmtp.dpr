...
const
  ConSmtpVersion = 101;
  CopyRight      = ' ConSmtp (c) 2002 by Francois PIETTE. V1.01';
...
const
    ...
    { This is your sign on. Usually just your first and last names }
    WhoYouAre        = 'Firstname LastName';
    { And here your own email address }
    YourEmailAddress = 'user.name@domain.name';
    { And finally the destination email address }
    DestinationEmail = 'francois.piette@pophost.eunet.be';
