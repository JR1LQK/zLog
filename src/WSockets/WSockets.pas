...
type
  ...
  TCustomWSocket2 = class(TComponent)
  private
  ...
  TTCPClient = class(TCustomWSocket2)
  private
    FHandle: HWND;
  ...
  TTCPServer = class(TCustomWSocket2)
  private
    FHandle: HWND;
    FPort: string;
  ...
  TUDPClient = class(TCustomWSocket2)
  private
    FHandle: HWND;
  ...
  TUDPServer = class(TCustomWSocket2)
  private
    FHandle: HWND;
    FPort: string;
...
(**** TCustomWSocket2 Class ****)

constructor TCustomWSocket2.Create(AOwner: TComponent);
var
  WSAData: TWSAData;
begin
...
destructor TCustomWSocket2.Destroy;
begin
...
function TCustomWSocket2.GetSockAddrIn(
...
function TCustomWSocket2.GetAnySockAddrIn(
...
function TCustomWSocket2.GetBroadcastSockAddrIn(
         Port: string; var SockAddrIn: TSockAddrIn): boolean;
var
  ProtoEnt: PProtoEnt;
  ServEnt: PServEnt;
...
function TCustomWSocket2.SockAddrInToName(SockAddrIn: TSockAddrIn): string;
var
  HostEnt: PHostEnt;
begin
...
function TCustomWSocket2.SockAddrInToAddress(SockAddrIn: TSockAddrIn): string;
begin
  Result:= inet_ntoa(SockAddrIn.sin_addr);
end;

function TCustomWSocket2.SockAddrInToPort(SockAddrIn: TSockAddrIn): string;
begin
  Result:= IntToStr(ntohs(SockAddrIn.sin_port));
end;

function TCustomWSocket2.SocketToName(Socket: TSocket): string;
var
...
function TCustomWSocket2.SocketToAddress(Socket: TSocket): string;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
begin
...
function TCustomWSocket2.SocketToPort(Socket: TSocket): string;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
begin
...
function TCustomWSocket2.PeerToName(Socket: TSocket): string;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
  HostEnt: PHostEnt;
...
function TCustomWSocket2.PeerToAddress(Socket: TSocket): string;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
begin
...
function TCustomWSocket2.PeerToPort(Socket: TSocket): string;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
begin
...
procedure TCustomWSocket2.SocketClose(var Socket: TSocket; Handle: HWND);
var
  RC: integer;
begin
  if Socket <> INVALID_SOCKET then
...
function TCustomWSocket2.SocketQueueSize(Socket: TSocket): longint;
var
  Size: longint;
begin
  Result:= 0;
...
procedure TCustomWSocket2.SocketWrite(Socket: TSocket; Flag: integer; Data: string);
var
...
function TCustomWSocket2.SocketRead(Socket: TSocket; Flag: integer): string;
var
  Received: longint;
begin
  Result:= '';
...
function TCustomWSocket2.SocketWriteBuffer(Socket: TSocket; Buffer: Pointer; Size, Flag: integer): integer;
begin
...
function TCustomWSocket2.SocketReadBuffer(Socket: TSocket; Buffer: Pointer; Size, Flag: integer): integer;
begin
...
procedure TCustomWSocket2.SocketWriteTo(Socket: TSocket; Flag: integer; Data: string; var SockAddrIn: TSockAddrIn);
var
  TotSent, ToSend, Sent, ErrorLoop: integer;
begin
  if Data <> '' then
...
function TCustomWSocket2.SocketReadFrom(Socket: TSocket; Flag: integer; var SockAddrIn: TSockAddrIn): string;
var
  Len: integer;
  Received: longint;
begin
...
function TCustomWSocket2.SocketWriteBufferTo(Socket: TSocket; Buffer: Pointer; Size, Flag: integer; var SockAddrIn: TSockAddrIn): integer;
begin
...
function TCustomWSocket2.SocketReadBufferFrom(Socket: TSocket; Buffer: Pointer; Size, Flag: integer; var SockAddrIn: TSockAddrIn): integer;
var
  Len: integer;
begin
  Len:= SizeOf(SockAddrIn);
...
procedure TCustomWSocket2.SocketError(Error: integer);
begin
  FLastError:= Error;
...
function TCustomWSocket2.LastErrorDesc: string;
begin
  case FLastError of
...
function TCustomWSocket2.GetLocalHostAddress: string;
var
  SockAddrIn: TSockAddrIn;
  HostEnt: PHostEnt;
...
function TCustomWSocket2.GetLocalHostName: string;
var
  szHostName: array[0..128] of char;
begin
  if gethostname(szHostName, 128) = 0 then
