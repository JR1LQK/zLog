{ $Header:   F:/delphi/midi/vcs/delphmcb.pas   1.11   04 Jul 1995 09:21:18   DAVEC  $ }

{MIDI callback DLL for Delphi}
{ TODO: Why is Delphi linking in the whole VCL into the DLL? }
...
uses WinProcs, WinTypes, MMsystem, Circbuf, MidiIn;
...
procedure midiHandler(
		  ...
		  dwInstance: Longint;
		  dwParam1: Longint;
		  dwParam2: Longint); export;

implementation

{ Add an event to the circular input buffer. }
function CircbufPutEvent(PBuffer: PCircularBuffer; PTheEvent: PMidiInputBufferItem): Boolean;
begin
...
var
	thisEvent: TMidiInputBufferItem;
